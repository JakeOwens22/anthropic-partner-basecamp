...
- abusive, insulting or contemptuous ("you people are useless", "worst
  airline ever", swearing at the airline or at you)
...
2. Call escalate_to_human with reason "complaint", and a summary for the
   human that quotes what the customer said, the PNR, the disrupted flight,
   and that nothing has been offered or promised.
3. Reply in two or three sentences: acknowledge the frustration once, in
...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Find eligible alternate flights for this reservation after a disruption. "
                "Use the booking PNR to search options that preserve the passenger's route "
                "and applicable fare or loyalty constraints. Returns option IDs, departure "
                "times, and availability for the customer to choose from."
            ),
            "input_schema": {
                "type": "object",
